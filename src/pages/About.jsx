    ...
    return (
        <div className="flex flex-col sm:flex-row-reverse sm:justify-between h-full xl:px-16 md:px-6 px-4">
            <div className="flex items-center justify-center sm:w-1/3 ">
                <img src={stepping_stones_landscape} alt="stepping_stones_landscape" className="rounded-3xl shadow-xl" title="stepping_stones_landscape"></img>
            </div>
            <div className="my-auto sm:w-7/12 sm:text-lg">
                {/* <IoStar style={{fonstize: '40px'}} color="steelblue"/>
                <h1 className="text-4xl py-5 sm:text-5xl text-center sm:text-left font-extrabold text-blue-700">{t("about_heading")}</h1> */}
