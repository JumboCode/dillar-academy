      ...
      <div className="flex flex-col bg-white py-20 sm:py-40 gap-y-20 md:gap-32 mx-auto max-w-7xl">
        ...
        <div className="flex flex-col-reverse gap-4 sm:flex-row justify-around items-center">
          ...
          <div className={`px-2 md:px-0 text-center w-[484px] sm:text-left`}>
            <h3 className="font-extrabold mb-5">{t("home_class_level_title")}</h3>
            <h5 className=" mb-4">{t("home_class_level_desc")}</h5>
          </div>
        </div>
        {/* About classes */}
        <div className="flex flex-col gap-4 sm:flex-row justify-around items-center">
          <div className={"px-2 md:px-0 text-center w-[484px] md:text-left"}>
            <h3 className="font-extrabold mb-5">{t("home_level_title")}</h3>
            <h5 className="mb-4">{t("home_level_desc")}</h5>
          </div>
        ...
        <div className="flex flex-col-reverse gap-4 sm:flex-row justify-around items-center">
          ...
          <div className={`px-2 md:px-0 text-center w-[484px] md:text-left`}>
            <h3 className="font-extrabold mb-5">{t("home_learn_title")}</h3>
            <h5 className="mb-4">{t("home_learn_desc")}</h5>
          </div>
        </div>
      </div>
    </>
